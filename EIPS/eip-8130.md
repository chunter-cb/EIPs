...
interface IAccountConfiguration {
    ...
    struct ActorConfig {
        ...
        uint16 scope;       // grants bitmask; 0x00 = unrestricted (admin); 0x01 = SENDER; 0x02 = POLICY; 0x04 = NONCE; 0x08 = SELF_PAYER; 0x10 = SPONSOR_PAYER; 0x20 = DELEGATE; ERC-1271 signing requires operational authority (admin or SENDER without POLICY), not a grant
    }
